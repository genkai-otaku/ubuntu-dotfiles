...
echo "==> 1/8 前提パッケージ（git・curl・zsh）を確認"
...
echo "==> 3/8 リポジトリを $DOTFILES_DIR へ配置"
mkdir -p "$BASE_DIR"
...
echo "==> 7/8 Oh My Zsh と Powerlevel10k を導入"
